    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              @auth
              <a href="/profile" class="bg-green-500 p-2 mr-2 border border-1 text-white hover:text-gray-300 hover:bg-gray-600 rounded-sm">Profile</a>
              <form method="POST" action="{{Route("logout")}}" >
              @csrf 
              
              <button  class="bg-gray-800 p-2 border border-1 text-white hover:text-gray-300 hover:bg-gray-600 rounded-sm">Logout</button>
              </form>
              @endauth
      ...
      <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          ...
          <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contactr</a>
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base/5 font-medium text-white">Tanbir Ahmmed Sihab</div>
              <div class="text-sm font-medium text-gray-400">sihab.cse@gmail.com</div>
            </div>
